...
# use https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/greengrass.html#Greengrass.Client.list_subscription_definitions
...
class MyApp:
	...
	def usage(self):
		print ('Usage: list_subscription_definitions.py')
