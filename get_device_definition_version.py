...
# use https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/greengrass.html#Greengrass.Client.get_device_definition_version
...
class MyApp:
	...
	def usage(self):
		print ('Usage: get_device_definition_version.py')
	...
	def start(self):
		...
		response = client.get_device_definition_version(
			...
			DeviceDefinitionVersionId = self.version
		)
