...
# use https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/greengrass.html#Greengrass.Client.get_subscription_definition
...
class MyApp:
	...
	def usage(self):
		print ('Usage: get_subscription_definition.py')
