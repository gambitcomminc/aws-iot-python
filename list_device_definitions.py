...
# use https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/greengrass.html#Greengrass.Client.list_device_definitions
...
class MyApp:
	...
	def usage(self):
		print ('Usage: list_device_definitions.py')
